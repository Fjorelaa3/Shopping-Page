      ...
      if (cartCost == 0 || isNaN(cartCost)) {
        ...
        window.onclick = function (event) {
            if (event.target == modal) {
                //console.log("shtype jashte kutise");
                modal.style.display = "none";
            }
        }
...
function setNewPoints (cartCost){
    ...
    $.ajax({
        type:"POST",
        url:"../controllers/update_points.php", //?action=next
        data:points,
        //dataType: 'json',
        //cache: false,
 ...
 */
    ...
    emailjs.send("service_pfn4h3c","template_ywfjuri",tempParams).then(function (res) {
